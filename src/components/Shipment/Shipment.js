...
const Shipment = () => {
  ...
  return (
   ...
   {errors.name && <span className='error'>name  is required</span>}
      ...
      <input name="password" defaultValue={loggedInUser.password} ref={register({ required: true })}  placeholder= '     enter your password'/>
      
      {errors.password && <span className='error'>name  is required</span>}
